...
STORY = [
    ...
    ("key", "ENTER", 2.6),
    ("cap", "Choose repos while commits load in the background", 0.6),
    ...
    ("key", "]", 2.6),
    ("key", "DOWN", 0.6), ("key", "DOWN", 0.6), ("key", "DOWN", 1.6),
    ("cap", "Narrow it to the PRs that need you", 0.4),
    ("key", "@", 2.4),
    ("cap", "Merge, re-run or check out from the list", 0.4),
    ("key", "DOWN", 0.9),
    ("key", "m", 2.6),
    ("key", "y", 2.8),
    ...
    ("zoom", None, 0.6),
    ("key", "SPACE", 1.8),
    ("cap", "See what every release shipped", 0.4),
    ("key", "]", 2.0),
    ("key", "DOWN", 1.4),
    ("zoom", {"x": 49, "y": 5, "w": 67, "h": 17}, 3.0),
    ("cap", "Rollbacks say what they took out", 0.4),
    ("key", "UP", 2.8),
    ("zoom", None, 0.8),
    ("cap", "", 0.6),
]
